...
class Cms_settingsSeeder extends Seeder {
    ...
    {        
       ...
       $data = [
        ...
        [
            'created_at'=>date('Y-m-d H:i:s'),
            'name'=>'login_screen_background_image',
            'label'=>'Login Screen Background Image',
            'content'=>'vendor/crudbooster/assets/bg_blur3.jpg',
            'content_input_type'=>'upload_image',
            'group_setting'=>trans('crudbooster.application_setting'),
            'dataenum'=>NULL,
            'helper'=>NULL],
        [
            'created_at'=>date('Y-m-d H:i:s'),
            'name'=>'login_screen_background_colour',
            'label'=>'Login Screen Background Colour',
            'content'=>'white',
            'content_input_type'=>'text',
            'group_setting'=>trans('crudbooster.application_setting'),
            'dataenum'=>NULL,
            'helper'=>'Use color codes or color name, example: #FF0000 or red. This option will work if Background Image (above) has not been set'],
        [
            'created_at'=>date('Y-m-d H:i:s'),
            'name'=>'favicon',
            'label'=>'Favicon',
