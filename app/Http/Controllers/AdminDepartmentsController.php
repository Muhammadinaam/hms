<?php namespace App\Http\Controllers;
	...
	class AdminDepartmentsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Description','name'=>'description','type'=>'textarea','validation'=>'required|min:1|max:2000','width'=>'col-sm-10'];
	        ...
	        */
	        $this->load_css = array();
	     	...
	     	$this->col[] = ["label"=>"Doctors","name"=>"(select group_concat(doctors.name SEPARATOR '<br>') from department_doctor join doctors on doctors.id = department_doctor.doctor_id where department_doctor.department_id = departments.id) as doctors"];   
